...
namespace Radzen.Blazor
{
    ...
    {
        ClassList ButtonClassList(RadzenSelectBarItem item) => ClassList.Create("btn")
                            .Add("btn-primary", !Disabled && IsSelected(item))
                            .Add("btn-outline-primary", !Disabled && !IsSelected(item))
